...
/**
 * Database: Base class for all databases.
 ...
 *
 * Use static Generic::connect($dsn) call if you don't know
 ...
 *
 * Contains 3 classes:
 * - Database: common database methods
 * - BlobInteface: common BLOB support
 * - LastError: error reporting and tracking
 *
